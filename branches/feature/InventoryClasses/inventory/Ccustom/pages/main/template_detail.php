...
// +-----------------------------------------------------------------+
//  Path: /modules/inventory/custom/pages/main/template_detail.php
//
// start the form
...
$toolbar->icon_list['print']['params']    = 'onclick="beforePrint()" ';
$toolbar->icon_list['print']['icon']  	  = 'actions/document-print.png';
$toolbar->icon_list['print']['text']  	  = 'Print Label';
$toolbar->icon_list['print']['show']      = true;
...
<?php
  require (DIR_FS_WORKING . 'custom/pages/main/template_tab_gen.php'); // general tab
  require (DIR_FS_WORKING . 'pages/main/template_tab_hist.php'); // history tab
if ($cInfo->inventory_type == 'as' || $cInfo->inventory_type == 'sa') {
  require (DIR_FS_WORKING . 'custom/pages/main/template_tab_bom.php'); // bill of materials tab
}
