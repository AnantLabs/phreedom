...
define('BOX_CONTACTS_MAINTAIN_BRANCHES', 'Maintain Branches');
define('BOX_CONTACTS_NEW_CUSTOMER', 'New Customer');
define('BOX_CONTACTS_MAINTAIN_CUSTOMERS', 'Maintain Customers');
define('BOX_CONTACTS_NEW_EMPLOYEE', 'New Employee');
define('BOX_CONTACTS_MAINTAIN_EMPLOYEES', 'Maintain Employees');
define('BOX_CONTACTS_NEW_PROJECT', 'New Project');
define('BOX_CONTACTS_MAINTAIN_PROJECTS', 'Maintain Projects');
define('BOX_CONTACTS_NEW_VENDOR', 'New Vendor');
define('BOX_CONTACTS_MAINTAIN_VENDORS', 'Maintain Vendors');
