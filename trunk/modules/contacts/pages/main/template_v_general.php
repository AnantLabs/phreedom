...
<div id="tab_general">
  ...
  <legend><?php echo ACT_CATEGORY_CONTACT; ?></legend>
   <table>
    <tr>
     <td align="right"><?php echo constant('ACT_' . strtoupper($type) . '_SHORT_NAME') . ($auto_type ? ' ' . ACT_ID_AUTO_FILL : ''); ?></td>
     ...
     <td><?php echo html_pull_down_menu('dept_rep_id', $sales_rep_array, $cInfo->dept_rep_id ? $cInfo->dept_rep_id : $_SESSION['account_id']); ?></td>
    </tr>
    <tr>
    ...
    <tr>
	 ...
	 <td><?php 
	  ...
	  echo html_input_field('terms_text', gen_terms_to_language($cInfo->special_terms, true, 'AP'), 'readonly="readonly" size="20"') . '&nbsp;' . chr(10);
