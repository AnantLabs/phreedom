...
?>
	...
	?>
		<tr class="dataTableRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)">
			...
			<td width="10%" class="dataTableContent"><?php echo gen_locale_date($values['post_date']); ?></td>
...
?>
		    <tr onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)">
			  ...
			  <td width="10%" class="dataTableContent"><?php echo gen_locale_date($detail['post_date']); ?></td>
