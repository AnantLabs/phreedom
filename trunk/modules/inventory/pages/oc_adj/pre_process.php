...
// +-----------------------------------------------------------------+
//  Path: /modules/inventory/pages/my_popup_adj/pre_process.php
//
...
$heading_array['admin_id'] = OC_TEXT_USER;
$heading_array['purchase_invoice_id'] = TEXT_REFERENCE;
$heading_array['sku'] = TEXT_SKU;
$heading_array['description'] = TEXT_DESCRIPTION;
$heading_array['qty']        = TEXT_QUANTITY;
...
$field_list = array('m.id', 'm.purchase_invoice_id', 'm.post_date', 'm.store_id', 'm.admin_id', 'i.qty', 'i.sku', 'i.description');
...
$query_raw = "select " . implode(', ', $field_list) . " 
	...
	where i.sku <> '' and m.journal_id = 16" . $period_filter . $search . " order by m.id, $disp_order";
...
define('PAGE_TITLE', 'Inventory Adjustments');
?>
