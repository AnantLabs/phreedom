		  ...
		  <tr>
			...
			<td align="right">
			  <?php 
				...
				echo html_icon('emblems/emblem-unreadable.png', TEXT_DELETE, 'small', 'onclick="if (confirm(\'' . TEXT_DELETE_ENTRY . '\')) rowAction(\'group_setup\', \'delete\')"'); 
			  ?>
			</td>
		  </tr>
		<?php } ?>
		  ...
		  <tr>
			...
			<td align="right">
			  <?php 
				...
				echo html_icon('emblems/emblem-unreadable.png', TEXT_DELETE, 'small', 'onclick="if (confirm(\'' . TEXT_DELETE_ENTRY . '\')) rowAction(\'sort_setup\', \'delete\')"'); 
			  ?>
			</td>
		  </tr>
		  <?php } ?>
		  ...
		  <tr>
			...
			<td align="right">
			  <?php 
				...
				echo html_icon('emblems/emblem-unreadable.png', TEXT_DELETE, 'small', 'onclick="if (confirm(\'' . TEXT_DELETE_ENTRY . '\')) rowAction(\'crit_setup\', \'delete\')"'); 
			  ?>
			</td>
		  </tr>
		<?php } ?>
