...
// Build content box
                  $sql = "select audit_log.action_date, audit_log.action, audit_log.reference_id, audit_log.amount, users.display_name from audit_log, users where audit_log.user_id = users.admin_id and audit_log.action_date >= '" . date('Y-m-d',  time()) . "' order by audit_log.action_date desc";
