...
// +-----------------------------------------------------------------+
//  Path: /modules/inventory/pages/oc_main/template_main.php
//
...
?>
  <tr class="dataTableRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)">
	...
	<td class="dataTableContent" onclick="submitSeq(<?php echo $query_result->fields['id'] . ', \'edit\''; ?>)"><?php echo $query_result->fields['description_short']; ?></td>
        <td class="dataTableContent" align="right" onclick="submitSeq(<?php echo $query_result->fields['id'] . ', \'edit\''; ?>)"><?php echo $currencies->precise($price); ?></td>
