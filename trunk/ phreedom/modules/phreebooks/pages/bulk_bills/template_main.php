...
// Build the page
?>
<div class="pageHeading"><?php echo ORD_TEXT_20_V_WINDOW_TITLE; ?></div>
<div>
	  ...
	  <td width="45%" align="right" valign="top">
		<table border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<td class="main" align="right"><?php echo html_calendar_field($cal_bills0); ?></td>
		  </tr>
		  <tr>
...
<?php
	...
	while (!$query_result->EOF) {
	  ...
	  echo '<td class="main" align="center">' . gen_locale_date($due_dates['net_date']) . '</td>' . chr(10);
	  ...
	  echo '<td class="main" align="center">' . html_checkbox_field('pay_' . $idx, '1', false, '', ($extra_params ? 'disabled="disabled" ' : '') . 'onclick="bbUpdatePayValues(' . $idx . ')"') . '</td>' . chr(10);
	  echo '</tr>' . chr(10);
	  $idx++;
	  $query_result->MoveNext();
	}
