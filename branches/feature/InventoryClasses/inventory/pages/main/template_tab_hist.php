  ...
  <fieldset>
   ...
   <table class="ui-widget" style="border-collapse:collapse;width:100%">
	  <tr><td valign="top" width="50%">
		...
		<table class="ui-widget" style="border-collapse:collapse;width:100%">
		 <thead class="ui-widget-header">
		  <tr><th colspan="4"><?php echo 'Gemiddeld Gebruik (deze Maand uitgesloten)'; ?></th></tr>
		  <tr>
	  ...
	  <td valign="top" width="25%">
		...
		if ($sku_history['purchases']) {
		  ...
		  foreach ($sku_history['purchases'] as $value) {
		    ...
		    echo '<tr class="' . ($odd?'odd':'even') . '">' . chr(10);
			echo '  <td align="center">' . $dates['ThisMonth']. '</td>' . chr(10);
			echo '  <td align="center">' . $dates['ThisYear']. '</td>' . chr(10);
		    echo '  <td align="center">' . ($value['qty'] ? $value['qty'] : '&nbsp;') . '</td>' . chr(10);
