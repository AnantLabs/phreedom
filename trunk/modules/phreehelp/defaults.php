...
if (file_exists(DIR_FS_MODULES . 'phreedom/language/' . $_SESSION['langauge'] . '/manual/welcome.php')) {
  define('DOC_ROOT_URL', DIR_WS_MODULES . 'phreedom/language/' . $_SESSION['langauge'] . '/manual/welcome.php');
} else {
  define('DOC_ROOT_URL', DIR_WS_MODULES . 'phreedom/language/en_us/manual/welcome.php');
}
