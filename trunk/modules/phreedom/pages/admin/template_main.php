...
<?php
  echo add_tab_list('modules',   MENU_HEADING_MODULES,    !$def_tab              ? true : false);
  echo add_tab_list('company',   MENU_HEADING_MY_COMPANY, $def_tab=='company'    ? true : false);
  echo add_tab_list('config',    MENU_HEADING_CONFIG,     $def_tab=='config'     ? true : false);
  echo add_tab_list('email',     MENU_HEADING_EMAIL,      $def_tab=='email'      ? true : false);
  echo add_tab_list('currency',  SETUP_TITLE_CURRENCIES,  $def_tab=='currency'   ? true : false);
  ...
  echo add_tab_list('manager',   BOX_COMPANY_MANAGER,     $def_tab=='manager'    ? true : false);
