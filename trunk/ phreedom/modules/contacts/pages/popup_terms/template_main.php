...
// Build the page
?>
<div class="pageHeading"><?php echo ACT_POPUP_TERMS_WINDOW_TITLE; ?></div>
<table border="0" cellspacing="2" cellpadding="2">
  <tr>
	<td class="formAreaTitle" colspan="2"><?php echo ACT_TERMS_DEFAULT . ' ' . gen_terms_to_language('0', false, $terms_type) . '<br />' . chr(10); ?></td>
  </tr>
  <tr>
	<td class="main">
<?php
...
echo html_hidden_field('credit_limit', (isset($terms[4]) ? $terms[4] : $credit_limit));
echo html_calendar_field($cal_terms);
