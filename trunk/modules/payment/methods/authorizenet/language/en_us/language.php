...
define('MODULE_PAYMENT_AUTHORIZENET_TEXT_CVV', 'CVV Number (<a href="javascript:popupWindowCvv()">' . 'More Info' . '</a>)');
...
define('MODULE_PAYMENT_AUTHORIZENET_TEXT_DECLINED_MESSAGE', 'The credit card transaction did not process correctly. If no reason is given, the card was declined by the bank.');
