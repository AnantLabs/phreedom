...
// +-----------------------------------------------------------------+
//  Path: /modules/inventory/pages/oc_main/template_detail.php
//
...
<!-- start the tabsets -->
<?php
  require (DIR_FS_WORKING . 'pages/oc_main/template_tab_gen.php'); // general tab
  require (DIR_FS_WORKING . 'pages/oc_main/template_tab_hist.php'); // history tab
if ($cInfo->inventory_type == 'as' || $cInfo->inventory_type == 'sa') {
  require (DIR_FS_WORKING . 'pages/oc_main/template_tab_bom.php'); // bill of materials tab
}
if ($cInfo->inventory_type == 'ms') {
  require (DIR_FS_WORKING . 'pages/oc_main/template_tab_ms.php'); // master stock tab
}
