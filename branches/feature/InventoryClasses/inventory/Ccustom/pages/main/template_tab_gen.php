...
// +-----------------------------------------------------------------+
//  Path: /modules/inventory/custom/pages/main/template_tab_gen.php
//
?>
<div id="tab_general">
  ...
  <table class="ui-widget" style="border-style:none;width:100%">
	...
	<tr>
	  <td align="right">Verkoop Prijs inclusief btw</td>
	  <td id="old_full_price_incl_tax" > <?php 
	    echo html_input_field('full_price_incl_tax','', ' size="15" maxlength="20" style="text-align:right" ', false); ?>
	  </td>
	</tr>
	<tr>
...
<?php if ($_SESSION['admin_security'][SECURITY_ID_PURCHASE_INVENTORY] > 0) { ?>
	...
	<tr>
	  <td align="right">Marge</td>
	  <td id="old_marge"> <?php
	   	echo html_input_field('marge','', 'size="15" maxlength="5" style="text-align:right" ', false); ?>
	  </td>
	</tr>
	<tr>
