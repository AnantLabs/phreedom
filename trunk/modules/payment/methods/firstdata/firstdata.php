...
class firstdata {
  ...
  function keys() {
    return array(
	  array('key' => 'MODULE_PAYMENT_FIRSTDATA_CONFIG_FILE',       'default' => ''),
	  array('key' => 'MODULE_PAYMENT_FIRSTDATA_KEY_FILE',          'default' => ''),
	  array('key' => 'MODULE_PAYMENT_FIRSTDATA_HOST',              'default' => ''),
	  array('key' => 'MODULE_PAYMENT_FIRSTDATA_PORT',              'default' => ''),
	  array('key' => 'MODULE_PAYMENT_FIRSTDATA_TESTMODE',          'default' => 'Test'),
	  array('key' => 'MODULE_PAYMENT_FIRSTDATA_AUTHORIZATION_TYPE','default' => 'Authorize'),
	  array('key' => 'MODULE_PAYMENT_FIRSTDATA_SORT_ORDER',        'default' => '10'),
	);
  }
  ...
  function selection() {
	...
	$selection = array(
	   'id' => $this->code,
	   'page' => MODULE_PAYMENT_FIRSTDATA_TEXT_TITLE,
	   'fields' => array(
