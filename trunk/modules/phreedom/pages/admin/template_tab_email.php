...
?>
<div id="email" class="tabset_content">
  <h2 class="tabset_label"><?php echo MENU_HEADING_EMAIL; ?></h2>
  <fieldset class="formAreaTitle">
    <table border="0" width="100%" cellspacing="1" cellpadding="1">
	  <tr><th colspan="2"><?php echo MENU_HEADING_EMAIL; ?></th></tr>
	  <tr>
	    <td colspan="3"><?php echo CD_12_01_DESC; ?></td>
	  ...
	  <tr>
	    <td colspan="3"><?php echo CD_12_70_DESC; ?></td>
	  ...
	  <tr>
	    <td colspan="3"><?php echo CD_12_71_DESC; ?></td>
	  ...
	  <tr>
	    <td colspan="3"><?php echo CD_12_72_DESC; ?></td>
	  ...
	  <tr>
	    <td colspan="3"><?php echo CD_12_73_DESC; ?></td>
	  ...
	  <tr>
	    <td colspan="3"><?php echo CD_12_74_DESC; ?></td>
