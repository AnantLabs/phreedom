  ...
  <tr>
	...
	if ($result->RecordCount() > 0) {
		while(!$result->EOF) {
			...
			echo '    <td class="dataTableContent" align="right">' . ($result->fields['deliver_date'] ? gen_locale_date($result->fields['deliver_date']) : '&nbsp;') . '</td>' . chr(10);
			echo '    <td class="dataTableContent" align="right">' . ($result->fields['actual_date'] ? gen_locale_date($result->fields['actual_date']) : '&nbsp;') . '</td>' . chr(10);
