  ...
  <fieldset class="formAreaTitle">
    <table border="0" width="100%" cellspacing="1" cellpadding="1">
	  ...
	  <tr>
	    ...
	    <td><?php echo html_pull_down_menu('ar_add_sales_tax_to_shipping', $sel_yes_no, $_POST['ar_add_sales_tax_to_shipping'] ? $_POST['ar_add_sales_tax_to_shipping'] : AR_ADD_SALES_TAX_TO_SHIPPING, ''); ?></td>
	  </tr>
	  <tr>
