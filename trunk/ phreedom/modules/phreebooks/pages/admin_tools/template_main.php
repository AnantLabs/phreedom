	    ...
	    <tr>
		  ...
		  foreach ($fy_array as $key => $value) { 
			...
			if ($key > $max_period) { // only allow changes if nothing has bee posted above this period
				echo '<td width="33%" nowrap="nowrap">' . html_calendar_field($cal_gen[$i]) . '</td>' . chr(10);
			} else {
...
<p><?php echo GEN_ADM_TOOLS_REPOST_DESC; ?></p>
  <table align="center" border="0" cellspacing="2" cellpadding="1">
	...
	<tr>
	  ...
	  <td class="dataTableContent" colspan="2"><?php echo html_calendar_field($cal_start); ?></td>
	</tr>
	<tr>
	...
	<tr>
	  ...
	  <td class="dataTableContent" colspan="2"><?php echo html_calendar_field($cal_end); ?></td>
	</tr>
	<tr>
