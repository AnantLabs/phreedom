...
class inventory {
	...
	public function __construct($id, $sku, $inactive, $inventory_type, $description_short, $description_purchase, $description_sales, $image_with_path, $account_sales_income, $account_inventory_wage, $account_cost_of_sales, $item_taxable, $purch_taxable, $item_cost, $cost_method, $price_sheet, $price_sheet_v, $full_price, $item_weight, $quantity_on_hand, $quantity_on_order, $quantity_on_sales_order, $quantity_on_allocation, $minimum_stock_level, $reorder_quantity, $vendor_id, $lead_time, $upc_code, $serialize, $creation_date, $last_update, $last_journal_date){
		$product['id']  					= $id ;
		$product['sku'] 					= $sku ;
