...
$fieldset_content .= '<div class="pageHeading">' . TEXT_REPORT . ': ' . $doc_details->fields['doc_title'] . '</div>';
...
$fieldset_content .= '    <td>' . TEXT_TYPE . '</td>' . chr(10);
$fieldset_content .= '    <td>' . $phreeformTypes[$doc_details->fields['doc_ext']] . '</td>' . chr(10);
$fieldset_content .= '  </tr><tr>' . chr(10);
$fieldset_content .= '    <td>' . TEXT_GROUP . '</td>' . chr(10);
$fieldset_content .= '    <td>' . $groups['reports'][$doc_details->fields['doc_group']] . '</td>' . chr(10);
$fieldset_content .= '  </tr><tr>' . chr(10);
$fieldset_content .= '    <td>' . TEXT_CREATE_DATE . '</td>' . chr(10);
$fieldset_content .= '    <td>' . gen_locale_date($doc_details->fields['create_date']) . '</td>' . chr(10);
$fieldset_content .= '  </tr><tr>' . chr(10);
$fieldset_content .= '    <td>' . TEXT_LAST_UPDATE . '</td>' . chr(10);
$fieldset_content .= '    <td>' . gen_locale_date($doc_details->fields['last_update']) . '</td>' . chr(10);
$fieldset_content .= '  </tr></table>' . chr(10);
$fieldset_content .= '</td>' . chr(10);
// column 2
$fieldset_content .= '<td width="50%" valign="top">' . chr(10);
$fieldset_content .= '  <table width="100%"><tr>' . chr(10);
$fieldset_content .= '    <td align="center">' . '&nbsp;' . '</td>' . chr(10);
$fieldset_content .= '  </tr></table>' . chr(10);
$fieldset_content .= '</td>' . chr(10);
// end table
$fieldset_content .= '</tr></table>' . chr(10);
