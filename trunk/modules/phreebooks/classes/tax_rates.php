...
class tax_rates {
  ...
  function build_main_html() {
	...
	while (!$result->EOF) {
	  ...
	  if ($this->security_id > 3) $actions .= html_icon('emblems/emblem-unreadable.png', TEXT_DELETE, 'small', 'onclick="if (confirm(\'' . SETUP_TAX_DELETE_INTRO . '\')) subjectDelete(\'tax_rates\', ' . $result->fields['tax_rate_id'] . ')"') . chr(10);
    ...
    return html_datatable('tax_c_table', $content);
  }
