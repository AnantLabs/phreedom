...
switch ($action) {
  ...
  default:
	...
	$result      = html_heading_bar($heading_array, $_POST['sort_field'], $_POST['sort_order'], array(TEXT_STATISTICS, TEXT_ACTION));
	$list_header = $result['html_code'];
	$disp_order  = $result['disp_order'];
	if (!isset($_POST['sort_field'])) $disp_order = 'language';
