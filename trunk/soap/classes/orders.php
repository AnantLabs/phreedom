...
// BOF - Added by PhreeSoft for to map the shipping codes to Phreedom Codes
	...
	switch ($psOrd->shipper_code) {
	  default: 
	  case 'FedEx Ground (La': $psOrd->shipper_code = 'fedex_v7:GND';    break;
	  case 'FedEx Smart Post': $psOrd->shipper_code = 'fedex_v7:3Dam';   break;
	  case 'FedEx 1 Day Expr': $psOrd->shipper_code = 'fedex_v7:1DFrt';  break;
	  case 'FedEx 2 Day Expr': $psOrd->shipper_code = 'fedex_v7:2DFrt';  break;
	  case 'FedEx 3 Day Expr': $psOrd->shipper_code = 'fedex_v7:3DFrt';  break;
	  case 'FedEx LTL Priori': $psOrd->shipper_code = 'fedex_v7:GndFrt'; break;
	  case 'FedEx LTL Econom': $psOrd->shipper_code = 'fedex_v7:EcoFrt'; break;
	  case 'FedEx FedEx Home': $psOrd->shipper_code = 'fedex_v7:GDR';    break;
	  case 'FedEx Express Sa': $psOrd->shipper_code = 'fedex_v7:3Dpm';   break;
	  case 'FedEx Express 2 ': $psOrd->shipper_code = 'fedex_v7:2Dpm';   break;
	  case 'FedEx Standard O': $psOrd->shipper_code = 'fedex_v7:1Dpm';   break;
	  case 'FedEx Priority O': $psOrd->shipper_code = 'fedex_v7:1Dam';   break;
	  case 'Pickup From Stor': $psOrd->shipper_code = 'freeshipper:GND'; break;
	  case 'FREE SHIPPING! (': $psOrd->shipper_code = 'usps:3Dpm';       break; // TBD for OpenCart
	  case 'Flat (Best Way):': $psOrd->shipper_code = 'usps:2Dpm';       break; // TBD for OpenCart
	}
