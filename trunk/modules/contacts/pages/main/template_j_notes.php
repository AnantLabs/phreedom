...
// +-----------------------------------------------------------------+
//  Path: /modules/contacts/pages/main/template_j_notes.php
//
$cal_c_gen = array(
  'name'      => 'dateReference',
  'form'      => 'contacts',
	...
	<div style="float:right;width:50%">
	 <table class="ui-widget" style="border-collapse:collapse;width:100%">
	  ...
	  <tbody class="ui-widget-content">
	   <tr>
	    <td align="center"><?php echo html_pull_down_menu('crm_rep_id', $sales_rep_array, $cInfo->crm_rep_id); ?></td>
...
<?php if (sizeof($cInfo->crm_log) > 0) foreach ($cInfo->crm_log as $value) { ?>
	   <tr id="tr_crm_a_<?php echo $value->log_id; ?>" class="odd">
	    ...
	    <td><?php echo $sale_reps[$value->entered_by]; ?></td>
