...
<?php } else $hidden_fields .= html_hidden_field('store_id', $_SESSION['admin_prefs']['def_store_id']) . chr(10); ?>
  <tr>
    ...
    <td align="right" class="main"><?php echo TEXT_POST_DATE . ' ' . html_calendar_field($cal_adj); ?></td>
  </tr>
  <tr id="serial_row" style="display:none">
	<td class="main"><?php echo INV_HEADING_SERIAL_NUMBER; ?></td>
	<td colspan="2" class="main"><?php echo html_input_field('serial_1', $cInfo->serial_1, 'size="25" maxlength="24"'); ?></td>
  </tr>
  <tr>
