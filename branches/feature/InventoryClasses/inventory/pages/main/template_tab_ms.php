...
<div style="margin:auto;min-height:165px;">
 <?php if($cInfo->inventory_type=='ms'){?>
	    ...
	    <th colspan="2"><?php echo INV_TEXT_ATTRIBUTES; ?></th>
		  ...
		  <tr>
      		<td align="center" colspan="2">
  			  <table>
			    <tr>
				  <td><?php echo html_pull_down_menu('attr_index_0', $cInfo->attr_array0, '', 'size="5"'); ?></td>
	    ...
	    <th colspan="2"><?php echo INV_TEXT_ATTRIBUTES; ?></th>
		  ...
		  <tr>
      		<td align="center" colspan="2">
  			  <table>
			    <tr>
				  <td><?php echo html_pull_down_menu('attr_index_1', $cInfo->attr_array1, '', 'size="5"'); ?></td>
 ...
 <div>
  ...
  <table id="sku_list" class="ui-widget" style="border-collapse:collapse;width:33%">
   <thead class="ui-widget-header">
    <tr>
	  <th colspan="4" align="center"><?php if($cInfo->inventory_type=='ms') echo INV_MS_CREATED_SKUS; ?></th>
    </tr>
    <tr>
    	...
    	<?php $odd = true;
    	 If(!empty($cInfo->child_array)){
    		foreach ($cInfo->child_array as $value) {
			  	...
			  	if($value['inactive']==1)echo '<td style="background-color:pink">' . $value['sku'] . '</td>' . chr(10);
			  	else echo '<td>' . $value['sku'] . '</td>' . chr(10);
			  	echo '<td align="center">' . $value['desc'] . '</td>' . chr(10);
			  	echo '<td>' . $value['0'] . '</td>'. chr(10);
			  	echo '<td>' . $value['1'] . '</td>'. chr(10);
		      	echo '</tr>' . chr(10);
		      	$odd = !$odd;
    		}
    	} ?>
