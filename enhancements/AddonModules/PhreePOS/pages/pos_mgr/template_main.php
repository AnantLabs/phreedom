...
?>
  <tr class="<?php echo $odd?'odd':'even'; ?>" style="cursor:pointer">
	...
	<td align="center"><?php echo $currencies->format_full($query_result->fields['total_amount'], true, $query_result->fields['currencies_code'], $query_result->fields['currencies_value']); ?></td>
